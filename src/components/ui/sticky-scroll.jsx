                  ...
                  <Link key={item.id} href={`/product/`} className="block group">
                    <figure className='w-full relative overflow-hidden rounded-xl md:rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-500'>
                      <img
                        ...
                        alt="Product image"
                        loading="lazy"
                        className='transition-all duration-700 ease-out group-hover:scale-105 group-hover:rotate-1 w-full h-40 sm:h-64 md:h-[32rem] object-cover align-bottom'
                      />
                  ...
                  <Link key={item.id} href={`/product/`} className="block group">
                    <figure className='w-full relative overflow-hidden rounded-xl md:rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-500'>
                      <img
                        ...
                        alt="Product image"
                        loading="lazy"
                        className='transition-all duration-700 ease-out group-hover:scale-105 group-hover:rotate-1 w-full h-48 sm:h-72 md:h-[36rem] object-cover align-bottom'
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/0 to-black/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    </figure>
                  </Link>
