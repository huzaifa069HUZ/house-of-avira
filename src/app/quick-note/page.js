      ...
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 lg:p-16 rounded-3xl shadow-sm border border-black/5">
        ...
        <div className="space-y-12 font-dm-sans text-gray-700">
          ...
          <section className="group">
            <h2 className="text-xl md:text-2xl font-bold tracking-widest uppercase text-black mb-4 flex items-center gap-3">
        ...
        <div className="mt-16 pt-10 border-t border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/faq" className="flex flex-col items-center justify-center p-4 border border-gray-200 rounded-xl hover:border-[#8A001A] hover:shadow-sm transition-all group">
        ...
        <div className="mt-12 flex justify-center">
          <Link href="/catalogue" className="bg-black text-white px-10 py-4 rounded-xl font-bold tracking-widest uppercase text-xs hover:bg-[#8A001A] hover:-translate-y-1 transition-all duration-300 shadow-md">
            Continue Shopping
          </Link>
        </div>
