      ...
      <section className="w-full bg-[#000000] flex flex-col">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-4 aspect-auto md:aspect-[4/1.5] lg:aspect-[4/1.8]">
          {[
            ...
            <Link href={`/shop-aesthetic?category=${encodeURIComponent(look.title.toLowerCase())}`} key={idx} className="relative group overflow-hidden block w-full h-[60vh] md:h-full cursor-pointer">
